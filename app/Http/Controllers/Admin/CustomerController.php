...
class CustomerController extends Controller
{
  ...
  public function __construct(CustomerInterface $cust)
  {
  ...
  {
    return $this->cust->index($request);
  }
  public function getCustBrandProd(Request $request)
  {
    return $this->cust->getCustBrandProd($request);
  }
  ...
  {
    return $this->cust->customerProducts($request, $id);
  }
    ...
    if ($request->ajax()) {
      ...
      return Datatables::of($customerProducts)
        ...
        ->addColumn('seller_cost_status', function ($row) use ($id) {
          ...
          //     $html .= 'checked ';
          // }
          // $html .= 'name="seller_cost_status" class="form-check-input sellerCostSwitch" data-customer_id="'.$id.'" data-labelPid="'.$row->product_id.'">
          // </div>';
          return $html;
        })
  ...
  public function editCustomerBrand(Request $request)
  {
    if ($request->ajax()) {
      ...
      foreach ($customerProducts as $cProduct) {
        ...
        $html = $this->forecastLabels($request->customer_id, $brandId, $cProduct->product_id);
          ...
          array_push($products, array_combine($keys1, [$product->id, $product->name, number_format($html['available_label_qty']), '$ ' . $labelcost, $stat, $html['html']]));
        }
      // }
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      if (User::withTrashed()->where('email', $request->input('email'))->exists()) {
        ...
        DB::commit();
        return response()->json(['status' => true, 'msg' => 'Customer Added Successfully', 'customer_id' => $customerId]);
  ...
  public function editCustomerDetails($id)
  {
    ...
    if (!is_null($data['dataSet'])) {
      ...
      return view('admin.customers.edit_customer', compact('custServiceCharges', 'id', 'products', 'customerProducts', 'settingValues'))->with($data);
    } else {
      return redirect()->back()->with('error', 'User not found or deleted');
    }
  }
  /**
    ...
    try {
      ...
      if ($password == '') {
        ...
        if ($customer->service_charges) {
          ...
          //
          $customer->service_charges->discounted_postage_cost = $request->input('discounted_pc_custom');
          if ($request->discounted_default_postage_charges == 1) {
            $customer->service_charges->discounted_postage_cost_lt5 = $request->input('discounted_pc_1_4oz');
            $customer->service_charges->discounted_postage_cost_lt9 = $request->input('discounted_pc_5_8oz');
            $customer->service_charges->discounted_postage_cost_lt13 = $request->input('discounted_pc_9_12oz');
            $customer->service_charges->discounted_postage_cost_gte13 = $request->input('discounted_pc_13_15oz');
          } else {
            $customer->service_charges->discounted_postage_cost_lt5 = $request->input('pc_1_4oz');
            $customer->service_charges->discounted_postage_cost_lt9 = $request->input('pc_5_8oz');
            $customer->service_charges->discounted_postage_cost_lt13 = $request->input('pc_9_12oz');
            $customer->service_charges->discounted_postage_cost_gte13 = $request->input('pc_13_15oz');
          }

          //
          // LBS
          $customer->service_charges->lbs1_1_99 = $request->input('lbs1_1_99');
          $customer->service_charges->lbs1_1_2 = $request->input('lbs1_1_2');
          $customer->service_charges->lbs2_1_3 = $request->input('lbs2_1_3');
          $customer->service_charges->lbs3_1_4 = $request->input('lbs3_1_4');
          //
          if ($request->discounted_default_postage_charges == 1) {
            $customer->service_charges->discounted_lbs1_1_99 = $request->input('discounted_lbs1_1_99');
            $customer->service_charges->discounted_lbs1_1_2 = $request->input('discounted_lbs1_1_2');
            $customer->service_charges->discounted_lbs2_1_3 = $request->input('discounted_lbs2_1_3');
            $customer->service_charges->discounted_lbs3_1_4 = $request->input('discounted_lbs3_1_4');
          } else {
            $customer->service_charges->discounted_lbs1_1_99 = $request->input('lbs1_1_99');
            $customer->service_charges->discounted_lbs1_1_2 = $request->input('lbs1_1_2');
            $customer->service_charges->discounted_lbs2_1_3 = $request->input('lbs2_1_3');
            $customer->service_charges->discounted_lbs3_1_4 = $request->input('lbs3_1_4');
          }
          //
          // LBS
          ...
          $customer->service_charges->discounted_default_postage_charges = $request->input('discounted_default_postage_charges');
          ...
          ServiceCharges::create([
            ...
            'discounted_postage_cost' => $request->input('discounted_pc_custom'),
            'discounted_postage_cost_lt5' => $request->input('discounted_pc_1_4oz'),
            'discounted_postage_cost_lt9' => $request->input('discounted_pc_5_8oz'),
            'discounted_postage_cost_lt13' => $request->input('discounted_pc_9_12oz'),
            'discounted_postage_cost_gte13' => $request->input('discounted_pc_13_15oz'),

            //
            // LBS
            'lbs1_1_99' => $request->input('lbs1_1_99'),
            'lbs1_1_2' => $request->input('lbs1_1_2'),
            'lbs2_1_3' => $request->input('lbs2_1_3'),
            'lbs3_1_4' => $request->input('lbs3_1_4'),
            //
            'discounted_lbs1_1_99' => $request->input('discounted_lbs1_1_99'),
            'discounted_lbs1_1_2' => $request->input('discounted_lbs1_1_2'),
            'discounted_lbs2_1_3' => $request->input('discounted_lbs2_1_3'),
            'discounted_lbs3_1_4' => $request->input('discounted_lbs3_1_4'),
            //
            // LBS
            ...
            'discounted_default_postage_charges' => $request->input('discounted_default_postage_charges'),
  ...
  public function destroy($id)
  {
    try {
      ...
      return redirect()->back()->with('error', 'Under Construction');
    } catch (\Exception $e) {
      ...
      return Datatables::of($data)
        ...
        ->addColumn('action', function ($row) {
          $btn = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu">';
          if (Auth::user()->can('labels_create', Sku::class)) {
            $btn .= '<a class="dropdown-item" href="/brand/' . $row->id . '/sku">
                            <i data-feather="eye"></i>
                            <span>View SKU</span>
                        </a>';
          }
          if (Auth::user()->can('labels_create', Labels::class)) {
  ...
  //   if ($charges) {
  //     if (isset($setting)) {
  //       if ($setting->holiday_status == 1) {
  //         $holiday = $setting->holiday_status;
  //       }
  //     }
  //     return response()->json([
  //       'status' => 'success',
  ...
  public function editOrderGetServiceCharges(Request $request, $cid, $oid, $bid)
  {
    $order = Orders::where('customer_id', $cid)->where('id', $oid)->where('brand_id', $bid)->first();
    $charges = ServiceCharges::where('customer_id', $cid)->latest('updated_at')->first();
    if (isset($order)) {
      ...
      return response()->json([
        'status' => 'success',
        'data' => json_decode($order->customer_service_charges),
  ...
  public function updateCustomerProdSellingPrice(Request $request)
  {
    ...
    try {
      ...
      $customerBrands = Labels::where('customer_id', $request->customer_id)->get();
      foreach ($customerBrands as $cBkey => $brand) {
        $skus = Sku::where('brand_id', $brand->id)->get();
        foreach ($skus as $skukey => $sku) {
          if (isset($sku)) {
            $skuProducts = SkuProducts::where('sku_id', $sku->id)->where('product_id', $request->product_id)->get();
            foreach ($skuProducts as $skuProductkey => $sku_prod) {
              if (isset($sku_prod)) {
                $sku_prod->selling_cost = $request->selling_price;
                $sku_prod->save();
              }
            }
            foreach ($skuProducts as $skuProductkey => $sku_prod) {
              $sku = Sku::find($sku_prod->sku_id);
              $totalSellingCostOfSku = 0;
              $newSkuProducts = SkuProducts::where('sku_id', $sku->id)->get();
              foreach ($newSkuProducts as $skkey => $newValue) {
                $totalSellingCostOfSku += $newValue->selling_cost;
              }
              $sku->selling_cost = $totalSellingCostOfSku;
              $customerHasSku = CustomerHasSku::where('customer_id', $request->customer_id)->where('sku_id', $sku->id)->where('brand_id', $sku->brand_id)->first();
              if (isset($customerHasSku)) {
                $customerHasSku->selling_price = $totalSellingCostOfSku;
                $customerHasSku->save();
              }
              $sku->save();
            }
      ...
      return Datatables::of($data)
        ...
        ->addColumn('action', function ($row) {
          $btn = '<div class="dropdown">
                    ...
                    <div class="dropdown-menu">';
          if (Auth::user()->can('create', Sku::class)) {
            $btn .= '<a class="dropdown-item" href="/brand/' . $row->id . '/sku">
                          <i data-feather="eye"></i>
                          <span>View SKU</span>
                      </a>';
          }
          if (Auth::user()->can('update', Labels::class)) {
            $btn .= '<a class="dropdown-item" href="/brands/' . $row->id . '/edit">
                          <i data-feather="edit-2"></i>
                          <span>Edit Brand</span>
                      </a>';
          }
          if (Auth::user()->can('delete', Labels::class)) {
            $btn .= '<a class="dropdown-item" href="/delete/brand/' . $row->id . '" onclick="confirmDelete(event)">
                          <i data-feather="trash"></i>
                          <span>Delete Brand</span>
                      </a>';
  ...
  public function enableDiscountedPostage(Request $request)
  {
    try {
      if ($request->status == 1) {
        $this->updateServiceChargesForDiscountedPostage($request);
        return response()->json(['status' => true, 'msg' => 'Discounted postage enabled for this customer']);
      } else {
        $this->updateServiceChargesForDiscountedPostage($request);
        return response()->json(['status' => true, 'msg' => 'Discounted postage disabled for this customer']);
      }
    } catch (\Exception $e) {
      dd($e);
  ...
  public function updateServiceChargesForDiscountedPostage($request)
  {
    $status = 0;
    $discounted_postage_cost_lt5 = 0;
    $discounted_postage_cost_lt9 = 0;
    $discounted_postage_cost_lt13 = 0;
    $discounted_postage_cost_gte13 = 0;
    $discounted_lbs_1_1_99 = 0;
    $discounted_lbs1_1_2 = 0;
    $discounted_lbs2_1_3 = 0;
    $discounted_lbs3_1_4 = 0;
    if ($request->status == 1) {
      $status = $request->status;
      ...
      $discounted_lbs_1_1_99 = $request->discounted_lbs_1_1_99;
    ...
    ServiceCharges::where('customer_id', $request->customer_id)->update([
      'discounted_default_postage_charges' => $status,
      'discounted_postage_cost_lt5' => $discounted_postage_cost_lt5,
      'discounted_postage_cost_lt9' => $discounted_postage_cost_lt9,
      'discounted_postage_cost_lt13' => $discounted_postage_cost_lt13,
      'discounted_postage_cost_gte13' => $discounted_postage_cost_gte13,
      'discounted_lbs1_1_99' => $discounted_lbs_1_1_99,
      'discounted_lbs1_1_2' => $discounted_lbs1_1_2,
      'discounted_lbs2_1_3' => $discounted_lbs2_1_3,
      'discounted_lbs3_1_4' => $discounted_lbs3_1_4
    ]);
  }
}
