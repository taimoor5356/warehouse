                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Unit
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" enctype='multipart/form-data' action="{{route('units.store')}}" method="post">
                                       {{@csrf_field()}}
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="fp-default" class="form-control" name="name" value="{{old('name')}}" />
                                                        @error('name')
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-check form-check-primary form-switch">
                                                            <input type="checkbox" name="unit_type" value="1" class="form-check-input">
                                                        </div>
                                                        @error('unit_type')
                                                              <p class="text-danger">{{ $message }}</p>
                                                          @enderror
