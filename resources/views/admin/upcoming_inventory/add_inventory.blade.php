...
@section('title', 'Add Purchased Inventory')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Purchased Inventory
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add Purchased Inventory</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form form-horizontal" enctype='multipart/form-data' action="{{route('upcoming_inventory.store')}}" method="post">
                                       {{@csrf_field()}}
                                        <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="product_id" class="form-select select2" id="basicSelect">
                                                            ...
                                                            @foreach($products as $product)
                                                                <option {{ old('product_id') == $product->id ? 'selected' : '' }} @if($product->id == Request::route('id')) selected @endif value="{{$product->id}}">{{$product->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('product_id')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="fp-default" class="form-control flatpickr-basic flatpickr-input" name="purchase_date" value="{{old('date')}}" placeholder="MM/DD/YYYY" />
                                                        @error('date')
                                                              <p class="text-danger">{{ $message }}</p>
                                                          @enderror
                                                    </div>
