                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal editproductform" enctype='multipart/form-data' action="{{route('products.update',$dataSet['id'])}}" method="post">
                                       {{@csrf_field()}}
                                       @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="category_name" class="form-select" id="">
                                                            <option value="" >--Select Category--</option>
                                                            @foreach($cats as $cat)
                                                            <option @if($cat->id == $dataSet['category_id']) selected @endif value="{{$cat->id}}">{{$cat->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('category_name')
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" id="name" class="form-control" value="{{$dataSet['name']}}" name="name" placeholder="Enter Product Name" required/>
                                                        @error('name')
                                                              <p class="text-danger">{{ $message }}</p>
                                                          @enderror
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="product_unit_id" class="form-select" id="">
                                                            <option value="">--Select Unit--</option>
                                                            
                                                            @foreach($units as $unit)
                                                            <option @if($unit->id == $dataSet['product_unit_id']) selected @endif value="{{$unit->id}}">{{$unit->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label class="col-form-label" for="first-name" style="font-weight: bold">Weight</label>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input type="number" step="0.01" name="weight" id="weight" class="form-control" value="@if($dataSet['product_unit']['unit_type'] == 1){{number_format(($dataSet['weight'] / 16), 2)}}@else{{number_format($dataSet['weight'], 2)}}@endif" placeholder="Enter weight" required/>
                                                        @error('price')
                                                              <p class="text-danger">{{ $message }}</p>
                                                          @enderror
                                                    </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-icon">
                                                            <input type="number" step="0.01" id="cog" class="form-control" value="{{$dataSet['cog']}}" name="cog" placeholder="Enter Cost of Good" required/>
                                                            <i>$</i>
                                                        </div>
                                                        @error('cog')
                                                              <p class="text-danger">{{ $message }}</p>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-icon">
                                                            <input type="number" step="0.01" id="shipping_cost" class="form-control" value="{{ $dataSet['shipping_cost'] }}" placeholder="Enter Shipping Cost" name="shipping_cost"/>
                                                            <i>$</i>
                                                        </div>
                                                        @error('shipping_cost')
                                                              <p class="text-danger">{{ $message }}</p>
