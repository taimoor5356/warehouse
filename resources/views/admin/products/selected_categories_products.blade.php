...
@section('content')
    ...
    <!-- BEGIN: Content-->
    <input type="hidden" id="c_id" value="{{$categories_ids}}" />
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-1">
                            <textarea name="description" id="add-inventory-description" class="form-control" placeholder="Enter Notes"></textarea>
                        </div>
                    </div>
                            ...
                            {{-- <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9 upcoming_data">
                                                    <select name="product_id" class="form-select upcoming_input_field select2" id="modal_product_id">
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <label>Description: </label>
                        <div class="mb-1">
                            <textarea class="form-control" name="reduce-inventory-description" id="reduce-inventory-description" placeholder="Enter Notes"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary waves-effect waves-float waves-light"
                            id="reduce-inventory" data-bs-dismiss="modal">Add</button>
                        <button type="button" class="btn btn-dark waves-effect waves-float waves-light"
                            data-bs-dismiss="modal">Close</button>
                    </div>
                </form>
...
<script type="text/javascript">
    $(document).on('ready', function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            iDisplayLength: 50,
            "ajax": {
                "url": "{{ route('selected_categories_products') }}",
                "method": 'POST',
                "data": {
                    _token: "{{ csrf_token() }}",
                    "cid": $("#c_id").val(),
            ...
            'columns': [
                ...
                },
                {
                    ...
                    name: 'ordered', render: $.fn.dataTable.render.number( ',', 2),
                    orderable: false,
                },
                {
                    data: 'otw', render: $.fn.dataTable.render.number( ',', 2),
                    name: 'otw', render: $.fn.dataTable.render.number( ',', 2),
                    orderable: false,
                },
                {
                    data: 'weight',
        ...
        $(document).on('click', '.otw-inventory-each-item', function(e) {
            ...
            if (product_id != '') {
                ...
                //         let tableRow='';
                //         $('#otwInventoryModalTableBody').empty();
                //         if(reponse.success){
                //             reponse.upcomingInventory.forEach(element => {
                //                 var date1 = new Date(); // today date
                //                 var date2 = new Date(element.date);
                ...
                //                             <a data-bs-toggle="modal" class="movestock dropdown-item" data-product-id-otw="${element.product_id}" data-row-id-otw="${element.id}"  data-otw-quantity="${element.qty}" data-bs-target="#move_to_stock_modal" data-bs-placement="top" title="Add This to Stock">
                //                             <i data-feather="briefcase"></i>Move To Sock
                //                             </a>
                //                             <a href="/otw_inventory/${element.id}/edit"class="dropdown-item"  data-bs-toggle="tooltip" data-bs-placement="top" title="Edit OTW Inventory Date">
                //                                                     <i data-feather="edit-2"></i>edit
                //                             </a>
                //                             <a data-bs-toggle="tooltip" class="dropdown-item" data-bs-placement="top" title="Delete OTW Inventory" href="/delete/otw/inventory/${element.id}" onclick="return myFunction()">
                ...
                //             </tr>
                //             `;
                //            $('#otwInventoryModalTableBody').append(tableRow);
                //            });
                //         }
                //        else
                //         {
                //             tableRow=`
                //                 <tr class=" text-center"><td colspan="3"><h4>No record found.</h4></td></tr>
                //             `;
                //            $('#otwInventoryModalTableBody').append(tableRow);
        ...
        //   window.upcomintInventoryModalTable = $('#upcomingInventoryModalTable').DataTable();
    ...
    $(document).ready(function() {
        ...
        $(document).on("keyup , change", "#qty", function() {
            ...
            console.log(upcoming_quantity, qty);
