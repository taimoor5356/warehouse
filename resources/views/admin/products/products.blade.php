                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-8 addBtnClass">
                            @can('product_create')
                                <a href="/products/create" style="margin-left:auto;"
                                    class="btn btn-primary waves-effect waves-float waves-light">Add New Product</a>
                            @endcan
                            @can('product_delete')
                                <a href="/products/trash" style="margin-left:auto;"
                            ...
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9 upcoming_data">
                                        <textarea name="description" id="description" cols="10" rows="2" class="form-control upcoming_input_field"></textarea>
                                        <div class="error_msg text-danger d-none">This field is Required</div>
                                        @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <p class="text-danger text-bold d-none" id="error_message_otw_qty">Quantit No
...
<script type="application/javascript">
    ...
    $(document).on('ready', function() {
        ...
        $(document).on('click', '.reduce-inventory', function(e) {
            ...
            $('#reduce-inventory-description').val('');
        });
        $(document).on('click', '#reduce-inventory', function(e) {
            e.preventDefault();
            var prod_id = $(this).data('prod-id');
    ...
    $('body').on("click", ".movestock", function() {
        var productIdotw = $(this).data('product-id');
        var rowId = $(this).data('row-id');
