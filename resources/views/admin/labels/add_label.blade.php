    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Add Brand</h2>
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" enctype='multipart/form-data' action="{{route('brands.store')}}" method="post">
                        {{@csrf_field()}}
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="customer_id" class="form-select select2" id="basicSelect">
                                            ...
                                            <option @if($customer->id == $customer_id) selected @endif value="{{$customer->id}}">{{$customer->customer_name}}</option>
                                            @endforeach
                                        </select>
                                        @error('customer_id')
                            ...
                            {{-- <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">Select Labels</label>
                                    </div>
                                        <div class="input-group input-group-lg">
                                        <input type="number" id="qty" class="bootstrap-touchspin" value="1" name="qty" />
                                        @error('qty')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                    </div> 
                                    <div class=" col-sm-9">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="input-group input-group-lg">
                                                <input type="number" id="qty" class="touchspin2" value="1" name="qty" />
                                                @error('qty')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                            </div>
