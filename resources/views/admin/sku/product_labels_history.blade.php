...
@section('title', 'Product Labels History')
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table data-table table-bordered">
                                    ...
                                    <tbody>
                                       <input type="hidden" value="{{Request::route('p_id')}}" id="product_id">
                                       <input type="hidden" value="{{Request::route('c_id')}}" id="custID">
                                       <input type="hidden" value="{{Request::route('b_id')}}" id="brandID">
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
          ...
          $(function () {
            ...
            var url = '/customer/'+customer_id+'/brand/'+brand_id+'/product/'+product_id+'/labels';
            // url = url.replace(':p_id', product_id);
