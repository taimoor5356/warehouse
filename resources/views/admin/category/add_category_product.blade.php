    ...
    <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add Category Product</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/products">Categories</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="/categorywise/products/{{ $cat_id }}">Category Products</a>
                                    </li>
                                    <li class="breadcrumb-item active">Add Category Product
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" enctype='multipart/form-data' action="{{route('store_category_product', $cat_id)}}" method="post" id="add_product_id">
                                       {{@csrf_field()}}
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="category_name" class="form-select select2" id="basicSelect" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <select name="product_unit_id" class="form-select" id="basicSelect" required>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label class="col-form-label" for="weight" style="font-weight: bold">Weight (oz)</label>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input type="number" min="0.0" step="0.01" id="weight" class="form-control" value="" placeholder="Enter weight" name="weight" required/>
                                                        @error('weight')
                                                              <p class="text-danger">{{ $message }}</p>
                                                          @enderror
                                                    </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-icon">
                                                            <input type="number" min="0.0" step="0.01" id="cog" class="form-control" value="" placeholder="Enter Cost of Good" name="cog"/>
                                                            <i>$</i>
                                                        </div>
                                                        @error('cog')
                                                              <p class="text-danger">{{ $message }}</p>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-icon">
                                                            <input type="number" min="0.0" step="0.01" id="shipping_cost" class="form-control" value="" placeholder="Enter Shipping Cost" name="shipping_cost"/>
                                                            <i>$</i>
                                                        </div>
                                                        @error('shipping_cost')
                                                              <p class="text-danger">{{ $message }}</p>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="input-icon">
                                                            <input type="number" min="0.0" step="0.01" id="price" class="form-control" placeholder="0.00" name="price" readonly required/>
                                                            <i>$</i>
                                                        </div>
                                                        @error('price')
                                                              <p class="text-danger">{{ $message }}</p>
                                            ...
                                            <div class="col-sm-12 offset-sm-2">
                                                ...
                                                {{-- <a class="btn btn-primary me-1 enter-pincode" href="#" data-type="add" data-bs-toggle="modal" data-bs-target="#enter_pin_Modal">Submit</a> --}}
