...
@section('title', 'Brand Labels History')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/customer/{{request()->route()->id}}/brands">Brands</a>
                                    </li>
    ...
    $(document).ready(function(){
      ...
      $(function () {
        var table = $('.data-table').DataTable({
            ...
            stateSave: true,
            "ajax": {
            "url": "/customer/{{request()->route()->id}}/brand/{{request()->route()->brand_id}}/labels/history",
            "data": {
                "pid": $("#p_id").val(),
            }
            },
