                ...
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="row">
                            <div class="col-6">
                            <h2 class="content-header-title float-start mb-0">Brand Products</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Brand Products
                                    </li>
                                </ol>
                            </div>
                             </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" enctype='multipart/form-data' action="/customer/#/brand/store" method="post">
                       {{@csrf_field()}}
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="brand" id="customer_id" class="select2 form-control">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '#customer_id', function() {
                ...
                var url = '{{ route("customer-brand", ":id") }}';
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        for(var i = 0; i < response.data.length; i++) {
                            html += `<option value="`+response.data[i].id+`">`+response.data[i].brand+`</option>`;
                        }
